...
public abstract class EnumerationTrackingEnumerable < T > : IEnumerable < T >
{
    protected abstract IEnumerator < T > GetEnumerator ( );
    protected abstract void              OnEnumerated  ( );
    ...
    {
        private readonly EnumerationTrackingEnumerable < T > enumerable;
        private readonly IEnumerator                   < T > enumerator;

        public Enumerator ( EnumerationTrackingEnumerable < T > enumerable )
        {
        ...
        {
            enumerator.Dispose      ( );
            enumerable.OnEnumerated ( );
        }
    }
}

// TODO: Rename...
public abstract class BindableEnumerableBase < T > : EnumerationTrackingEnumerable < T >, IBindableEnumerable < T >
{
...
public class BindableEnumerable < T > : BindableEnumerableBase < T >
{
    ...
    private readonly BindableEnumerableOptions _options;
