...
{
	// NOTE: Hide inside internal interface? + Add CollectionChangeSet
	IEnumerable < CollectionChange < TResult > > ProcessChanges ( IEnumerable < CollectionChange < TSource > > changes );
}
